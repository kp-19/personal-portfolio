...
const Header: React.FC<DarkModeProps> = ({ isDarkMode, setIsDarkMode }) => {
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
        ...
        >
        Hi! I am Krishna Patil <Image src={assets.hand_icon} alt='' className='w-6'/></motion.h3>
        ...
        >
            Computer Science Engineer based in Pune.
        </motion.h1>
        ...
        >
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum quasi illo impedit voluptate 
            suscipit ratione quam! Ipsum quod at maiores sunt vero dolor incidunt architecto 
            quasi ullam repellat. Est, nesciunt.
        </motion.p>
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
            ...
            <motion.a href="/sample-resume.pdf" download className='px-10 py-3 border rounded-full
